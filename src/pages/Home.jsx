...
export default function Home() {
  ...
  return (
    <div className="main container flex1 flex column">
      <Filter handleSearch={handleSearch}  setNavigation={setNavigation}
            setTransition={setTransition} transition={transition}> </Filter>
  ...
  >
    ...
    <PlayList  transition={transition}
      ...
      {navigation === "home" && (
        <div className="main-container flex  center align-center">
...
<div className="btn-container">
      <button className="btn" onClick={handleNextPage}><img src={next}></img></button>
      <button className="btn" onClick={() => handleviewChange("tile")}><img src={tile}></img></button>
      <button className="btn" onClick={() => handleviewChange("list")}><img src={list}></img></button>
</div>
}
    </div>
